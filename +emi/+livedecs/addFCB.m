classdef addFCB < emi.livedecs.Decorator
    % Adds If block
        ...
        function go(obj, varargin )
            ...
            if obj.is_minrange_inf
                ...
                o_blk_type = obj.mutant.get_compiled_type(...
                    obj.mutant.sys, oblk, 'Outport', oport);
            end
            ...
            obj.mutant.add_conn(obj.hobj.parent, new_if, 2, obj.hobj.all_new_ss_h{1}, 'Ifaction');
            obj.mutant.add_conn(obj.hobj.parent, new_if, 1, obj.hobj.all_new_ss_h{2}, 'Ifaction');
            
            if_name = strsplit(oblk,'/');
            i = size(if_name,2);
            if_na = if_name{i}
            obj.mutant.add_conn(obj.hobj.parent, if_na, oport, new_if, 1);
