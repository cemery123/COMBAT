classdef new_mcmc < emi.decs.DecoratedMutator
    ...
    methods
        ...
        function obj = new_mcmc(varargin)
        ...
        function main_phase(obj)
            ...
            try
                ...
                live_blocks = obj.r.sample_dead_blocks_to_delete();
        ...
        function new_block = change_block(obj, block, mut_op)
            ...
            if mut_op == 4
                ...
                for i = 1:size(obj.mutant.blocks,1)
                 if strcmp(block,obj.mutant.blocks(i,1).fullname)
                     true_candi_id = i;
                     break;
                 else
                 end
